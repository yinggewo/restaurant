...
public class DBYelpImport {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("DBYelpImport: import is done successfully.----drop");
			...
			System.out.println("DBYelpImport: import is done successfully.--table creation");
			...
			System.out.println("DBYelpImport: import is done successfully.--insert user");
